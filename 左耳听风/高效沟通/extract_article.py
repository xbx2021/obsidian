...
def html_to_markdown(html_content):
    ...
    # First, handle <li><p> pattern - convert to list item with content
    result = re.sub(r'<li>\s*<p>(.*?)</p>\s*</li>', r'\n- \1', result, flags=re.DOTALL)
    
    # Handle remaining <li> without <p>
    ...
    # Remove multiple consecutive newlines (keep at most 2)
    result = re.sub(r'\n{3,}', '\n\n', result)
    
    # Remove trailing space after list marker
...
try:
    ...
    with urllib.request.urlopen(req) as response:
        ...
        if 'data' in json_data and 'article_content' in json_data['data']:
            ...
            article_title = json_data['data'].get('article_title', 'article')
            ...
            print("article_content not found in response")
