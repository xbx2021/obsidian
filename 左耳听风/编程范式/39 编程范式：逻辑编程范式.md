![](assets/39%20编程范式：逻辑编程范式/file-20260523164746206.png)
...
mortal_report:- write('Known mortals are:'), nl, mortal(X),
write(X),nl,
fail.
...
![](https://static001.geekbang.org/resource/image/db/cb/db670cfbe7497d71eba70d60d8aa0fcb.png?wh=935*484)
...
``` 
germany(SH, MV, HH, HB, NI, ST, BE, BB, SN, NW, HE, TH, RP, SL, BW, BY) :- neighbor(SH, NI), neighbor(SH, HH), neighbor(SH, MV),
neighbor(HH, NI),
