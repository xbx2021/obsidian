![](assets/38%20编程范式：编程的本质/file-20260523164725101.png)
...
![](https://static001.geekbang.org/resource/image/5f/e2/5f45a22a027375c5960f5a6b31159ce2.png?wh=755*567)
...
function check_form_x() {
    var name = $('#name').val();
    if (null == name || name.length  程序代码的混乱不堪；
