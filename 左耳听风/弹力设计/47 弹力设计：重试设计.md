![](assets/47%20弹力设计：重试设计/file-20260523171404356.png)
...
[Spring Retry](https://github.com/spring-projects/spring-retry) 是一个单独实现重试功能的项目，我们可以通过 Annotation 的方式使用。具体如下。
```java
@Service
...
这些策略可以用 Java 的 Annotation 来实现，或者用 Service Mesh 的方式，从而不必写在业务逻辑里。最后，我总结了重试设计的重点。下节课，我们讲述熔断设计。希望对你有帮助。
