![](assets/第24讲%20有哪些方法可以在运行时动态生成一个Java类？/file-20260607190052294.png)
...
当然也可以，不过直接去写字节码难度太大，通常我们可以利用 **Java 字节码操纵工具和类库**来实现，比如在专栏第 6 讲中提到的ASM、Javassist、cglib 等。
