...
![](assets/11%20渐进式披露架构设计/file-20260424165532682.png)
...
![](assets/11%20渐进式披露架构设计/file-20260424165725149.png)

如图所示，此时，Claude 只读取了 .claude/skills/financial-analyzing/reference/profitability.md 这一个文件的 83 行。
![](assets/11%20渐进式披露架构设计/file-20260424165752604.png)
...
Token 消耗：全部资源都用到了。
![](assets/11%20渐进式披露架构设计/file-20260424170009866.png)

## 两个场景的关键对比
![](assets/11%20渐进式披露架构设计/file-20260424170026589.png)
...
请看下面的知识拆分决策树。
![](assets/11%20渐进式披露架构设计/file-20260424171519130.png)
...
超过 500 行时的重构信号和对策如下：
![](assets/11%20渐进式披露架构设计/file-20260424171736126.png)

拆分决策树和目录结构不是随意设计的——它们映射到**企业知识管理的经典范式**。
![](assets/11%20渐进式披露架构设计/file-20260424171851194.png)
上面这个映射的工程启示有哪些？
...
![](assets/11%20渐进式披露架构设计/file-20260424172452234.png)
...
![](assets/11%20渐进式披露架构设计/file-20260424172725284.png)
...
![](assets/11%20渐进式披露架构设计/file-20260424173043641.png)
![](assets/11%20渐进式披露架构设计/file-20260424173113236.png)
...
![](assets/11%20渐进式披露架构设计/file-20260424173450016.png)**组合使用**：一个子代理可以通过  skills  字段预加载 Skill，而该 Skill 内部仍然用渐进式披露组织内容。两种策略是互补的。
