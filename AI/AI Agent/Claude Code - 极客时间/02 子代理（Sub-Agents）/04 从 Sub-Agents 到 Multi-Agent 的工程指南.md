...
![](assets/03%20子代理Sub-Agents/file-20260427143819167.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821362.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821368.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821354.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821349.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821343.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821337.png)

## 场景二：重复请求效率（第二轮相同类型的请求）
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821332.png)
## 场景三：多领域查询（如“对比 Python/JS/Rust 的性能”）
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821326.png)
...
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821320.png)
## 第二阶段：单 Agent + Skills

当工具数量增多、prompt 变得臃肿时，用 Skills 实现渐进式加载。
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821314.png)
## 第三阶段：Supervisor + Sub-Agents

当不同领域需要独立的上下文空间和专业知识时引入。
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821310.png)
## 第四阶段：混合架构

成熟系统中，不同类型的任务流可能采用不同的模式。Router 处理分类，Sub-Agent 处理并行研究，Handoff 处理顺序流程。
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821306.png)
...
模式选择速查表
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821300.png)
...
开源社区里的 OpenClaw，在设计上走的是一条非常克制的路线：它并没有一开始就强调“多 Agent 协作”，而是把重心放在**任务拆分、执行隔离和结果回收**上。
![](assets/04%20从%20Sub-Agents%20到%20Multi-Agent%20的工程指南/file-20260427143821291.png)
