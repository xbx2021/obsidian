...
![](assets/05%20构建只读型安全审计子代理/file-20260427143823387.png)
# 从工程痛点到子代理设计：一种思维方式
...
![](assets/05%20构建只读型安全审计子代理/file-20260427143823374.png)
...
![](assets/05%20构建只读型安全审计子代理/file-20260427143823314.png)
...
![](assets/05%20构建只读型安全审计子代理/file-20260427143823304.png)
## 设计一个影响面分析子代理
...
对比下面两种实现方式：
![](assets/05%20构建只读型安全审计子代理/file-20260427143823299.png)
...
## 该创建子代理的场景
![](assets/05%20构建只读型安全审计子代理/file-20260427143823289.png)
具体判断标准可以参考下表。
![](assets/05%20构建只读型安全审计子代理/file-20260427143823280.png)
...
# 工作流
![](assets/05%20构建只读型安全审计子代理/file-20260427143823271.png)
