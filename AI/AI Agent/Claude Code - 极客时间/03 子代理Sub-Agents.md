...
![](assets/03%20子代理Sub-Agents/file-20260422142730700.png)
...
![](assets/03%20子代理Sub-Agents/file-20260422142730742.png)
...
![](assets/03%20子代理Sub-Agents/file-20260422142730801.png)
## description 的设计艺术
...
## model：模型选择与默认值
![](assets/03%20子代理Sub-Agents/file-20260422142730803.png)
## permissionMode：权限模式

permissionMode  控制子代理在执行过程中遇到需要权限的操作时如何处理。**子代理会继承主对话的权限上下文**，但可以通过此字段覆盖行为：
![](assets/03%20子代理Sub-Agents/file-20260422142730805.png)
...
![](assets/03%20子代理Sub-Agents/file-20260422142730807.png)
...
# 子代理的运行模式
子代理可以在前台或后台运行。
![](assets/03%20子代理Sub-Agents/file-20260422142730808.png)
