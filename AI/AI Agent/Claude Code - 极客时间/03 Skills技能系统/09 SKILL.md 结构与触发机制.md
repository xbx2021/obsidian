...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909132.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909127.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909121.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909051.png)
这就是为什么 Skills 在 Agent 时代具有特殊地位。它既不是单纯的工具层扩展，也不是应用层封装。它是认知层的调度结构，是企业本体论在模型世界中的映射。
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909035.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909029.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909021.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909016.png)
假设你有 5 个 Skills，每个 SKILL.md 约 1000 tokens。
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909013.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909009.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143909004.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908990.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908985.png)
```markdown
# 参考型——Claude 自动选择是否使用
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908982.png)
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908976.png)
**allowed-tools**  字段用来限制 Skills 被激活时 Claude 能使用的工具。Skills 支持的工具包括：
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908972.png)
还可以更精细地控制 Bash 命令
```markdown
allowed-tools:
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908967.png)
...
![](assets/09%20SKILL.md%20结构与触发机制/file-20260427143908959.png)
