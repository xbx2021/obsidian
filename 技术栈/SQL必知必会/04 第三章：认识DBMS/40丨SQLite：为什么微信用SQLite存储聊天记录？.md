...
- cur.fetchone()方法，获取一条记录；

- cur.fetchmany(n) 方法，获取n条记录；

- cur.fetchall()方法，获取全部数据行。
比如我想获取全部的结果集，可以写成这样：
...
```
![](https://static001.geekbang.org/resource/image/d1/52/d11e7857bbf1da3a6b4db9c34d561e52.png?wh=1728*113)
