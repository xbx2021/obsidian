...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143918024.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143918021.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143918019.png)
...
知识本位   → 知识的价值不绑定平台 
```
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143918010.png)

# 为什么 SubAgents 不能出圈

理解了 Skills 为什么能出圈，再看 SubAgents 为什么不能——两者的对比揭示了一个深层的架构原理。
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917950.png)
根本原因在于：**Skills 封装的是知识（Knowledge），SubAgents 封装的是行为（Behavior）**。
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917946.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917944.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917941.png)
...
生态数据如下表所示：
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917937.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917935.png)
表面结论是，一个静态 Markdown 文件打败了按需检索的 Skill 系统。但这个结论需要更深层的分析。
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917934.png)
这个权衡，在第 9 讲就学过了——CLAUDE.md vs Skills 就是同一个 Push vs Pull 的设计决策。如下图所示。
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917932.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917927.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917925.png)
如果把这个升维后的映射完整展开，会形成一幅更完整的对照图。
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917921.png)
...
![](assets/14%20从Claude%20Code到行业开放标准/file-20260427143917912.png)
