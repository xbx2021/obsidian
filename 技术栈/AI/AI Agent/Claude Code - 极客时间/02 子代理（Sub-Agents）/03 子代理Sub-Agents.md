...
![](assets/03%20子代理Sub-Agents/file-20260427143819219.png)
...
![](assets/03%20子代理Sub-Agents/file-20260427143819206.png)
...
![](assets/03%20子代理Sub-Agents/file-20260427143819197.png)
## description 的设计艺术
...
## model：模型选择与默认值
![](assets/03%20子代理Sub-Agents/file-20260427143819188.png)
## permissionMode：权限模式

permissionMode  控制子代理在执行过程中遇到需要权限的操作时如何处理。**子代理会继承主对话的权限上下文**，但可以通过此字段覆盖行为：
![](assets/03%20子代理Sub-Agents/file-20260427143819183.png)
...
![](assets/03%20子代理Sub-Agents/file-20260427143819178.png)
...
# 子代理的运行模式
子代理可以在前台或后台运行。
![](assets/03%20子代理Sub-Agents/file-20260427143819172.png)
