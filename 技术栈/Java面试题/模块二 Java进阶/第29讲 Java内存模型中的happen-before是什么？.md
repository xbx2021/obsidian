![](assets/第29讲%20Java内存模型中的happen-before是什么？/file-20260607190055559.png)
...
前面我一直用 happen-before，而不是简单说前后，是因为它**不仅仅是对执行时间的保证，也包括对内存读、写操作顺序的保证**。仅仅是时钟顺序上的先后，并不能保证线程交互的可见性。
...
![](assets/第29讲%20Java内存模型中的happen-before是什么？/file-20260607190055561.png)
...
![](assets/第29讲%20Java内存模型中的happen-before是什么？/file-20260607190055562.png)
