![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053063.png)
...
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053060.png)
...
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053069.png)
...
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053066.png)
...
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053071.png)
...
我们来对比一下，这是默认参数情况的输出：
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053073.png)

下面是替换了默认 GC，并关闭 TieredCompilation 的命令行
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053075.png)
得到的统计信息如下，线程数目从 25 降到了 17，消耗的内存也下降了大概 1/3。
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053077.png)
...
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053083.png)
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053079.png)
...
-XX:+UseSerialGC
```
![](assets/第26讲%20如何监控和诊断JVM堆内和堆外内存使用？/file-20260607190053081.png)
