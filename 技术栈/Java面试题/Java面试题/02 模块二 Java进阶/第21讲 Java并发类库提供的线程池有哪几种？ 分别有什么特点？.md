![](assets/第21讲%20Java并发类库提供的线程池有哪几种？%20分别有什么特点？/file-20260607190050464.png)
...
![](assets/第21讲%20Java并发类库提供的线程池有哪几种？%20分别有什么特点？/file-20260607190050466.png)
...
![](assets/第21讲%20Java并发类库提供的线程池有哪几种？%20分别有什么特点？/file-20260607190050470.png)
...
通过配置不同的参数，我们就可以创建出行为大相径庭的线程池，这就是线程池高度灵活性的基础。[ThreadPoolExecutor 核心参数 + 工作流程](../06%20扩展/ThreadPoolExecutor%20核心参数%20+%20工作流程.md)
```java
...
![](assets/第21讲%20Java并发类库提供的线程池有哪几种？%20分别有什么特点？/file-20260607190050468.png)
